...
class AlarmDatabaseTest {
    ...
    fun addAlarm_Test() = runTest {
        // Given
        val alarm = Alarm(3, "Frenadol", 1, AlarmManager.INTERVAL_HALF_DAY, 20, 0)
    ...
    fun deleteAllAlarms_Test() = runTest {
        ...
        val alarmsBunch = listOf<Alarm>(
            Alarm(3, "Frenadol", 1, AlarmManager.INTERVAL_HALF_DAY, 20, 10),
            Alarm(4, "Aspirina", 1, AlarmManager.INTERVAL_FIFTEEN_MINUTES, 21, 20),
            Alarm(5, "Ketoconazol", 1, AlarmManager.INTERVAL_HALF_HOUR, 22, 30),
            Alarm(6, "Biotina", 1, AlarmManager.INTERVAL_DAY, 23, 40)
        )
